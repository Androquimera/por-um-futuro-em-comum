...
[Português](../../../pt/pesquisa/datacenters/dados.md) · **English**

**Version 0.2 · Accessed: 2026-09-10**

[Communities](communities.md) · [Sources](sources.md) · [Method](method.md)

## 1. The Dalles: the public series behind the reporting

We obtained the [OPB/Datawrapper chart CSV][D35], attributed to the city. It contains 13 annual rows. Its original text, including separators, is preserved in the `csv_original` field of this [source record](../../../dados/datacenters/the-dalles-opb.original.json), with SHA-256 and a description in both languages.
