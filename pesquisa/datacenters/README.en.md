...
The [regional cases](CASOS.en.md) show real disputes and different responses. Neither a private contract nor a permit removes the need to measure outcomes and assess cumulative effects.
