...
Obtivemos o [CSV do gráfico OPB/Datawrapper][D35], atribuído à prefeitura. O arquivo contém 13 linhas anuais. Preservamos seu texto original, inclusive separadores, no campo `csv_original` deste [registro de origem](dados/the-dalles-opb.original.json), com SHA-256 e descrição nos dois idiomas.
