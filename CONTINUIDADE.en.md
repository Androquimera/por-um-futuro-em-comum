...
Every publication identifies the model and reviewer as specified in [RESPONSABILIDADE.en.md](RESPONSABILIDADE.en.md). Current edition's model: GPT-6 Astra, high effort; human lead: andromedus. (@Androquimera).
